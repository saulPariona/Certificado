...
@section('contenido')
    <div class="flex justify-center items-center">
        <form method="post" enctype="application/x-www-form-urlencoded"
            ...
            @csrf
            <legend class="text-2xl font-bold text-gray-700 text-center p-4">Agregando asistente</legend>
            <div class="flex flex-col">
                <label class="text-lg text-gray-900 font-semibold mb-4" for="asistente">Asistente</label>

                <select class="p-2 text-lg text-gray-800  border-2 border-amber-600 rounded-sm" name="asistente"
                    id="asistente">
